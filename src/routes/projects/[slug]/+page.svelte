...
<article class="w-full max-w-screen-lg mx-auto">
	...
	<div class="w-full rounded-2xl bg-gray-800 border border-gray-600 p-4 mb-4">
		...
		/>
		<div
			class="bg-gradient-to-br from-primary-500 to-tertiary-500 text-transparent bg-clip-text mt-4"
		>
	...
	<!-- Post -->
	<div
		class="mx-auto prose prose-gray dark:prose-invert prose-img:rounded-xl prose-headings:text-primary-500 prose-p:text-[#fff4ef] prose-p:text-opacity-75 prose-headings:mb-2 pb-4"
	>
